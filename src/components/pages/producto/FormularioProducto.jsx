          ...
          <Form.Control
            ...
            {...register("nombreProducto", {
              ...
              minLength: {
                value: 4,
                message:
                  "El nombre del producto debe tener 4 caracteres como minimo ",
              },
              maxLength: {
                value: 50,
                message:
                  "El nombre del producto debe tener 50 caracteres como maximo",
              },
            })}
          />
          ...
          <Form.Control
            ...
            {...register("imagen", {
              ...
              pattern: {
                ...
                message:
                  "Debe ingresar una URL valida, con una imagen de formato(jpg,jpeg, gif,png)",
              },
            })}
          />
          ...
          <Form.Control
            ...
            {...register("descripcion_breve", {
              ...
              minLength: {
                value: 10,
                message:
                  "La descripcion breve debe tener 10 caracteres como minimo",
              },
              maxLength: {
                value: 50,
          ...
          <Form.Control
            ...
            {...register("descripcion_amplia", {
              ...
              minLength: {
                value: 50,
                message:
                  "La descripcion amplia debe tener 50 caracteres como minimo",
              },
              maxLength: {
                value: 200,
